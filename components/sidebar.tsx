...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* ---- Logout Button ---- */}
      <button
        className="max-md:mb-10 absolute bottom-6 flex items-center gap-3 w-[calc(100%-50px)] px-4 py-2 rounded-lg text-sidebar-foreground hover:bg-red-400 cursor-pointer bg-red-600  transition-colors"
