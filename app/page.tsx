...
export default function Home() {
  const features = [
    { icon: <MapPin className="w-6 h-6" />, title: "Smart Location Finder", desc: "Find study spots near you with real-time availability" },
    { icon: <Clock className="w-6 h-6" />, title: "Real-time Updates", desc: "Live seat availability and noise level monitoring" },
    { icon: <Users className="w-6 h-6" />, title: "Community Ratings", desc: "Verified reviews from fellow students" },
    { icon: <Wifi className="w-6 h-6" />, title: "Amenity Filters", desc: "Filter by WiFi, power outlets, coffee, and more" },
  ]
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="text-center space-y-8">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Discover quiet libraries, cozy cafes, and productive workspaces tailored to your study needs. 
                Real-time availability, verified reviews, and smart recommendations.
              </p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700">{spot.seats} seats available</span>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <Button className="w-full group-hover:bg-blue-600 transition-colors">
                      Reserve Spot <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
                  </div>
                </div>
              ))}
